...
void conferir_itemLista(int item){
    if(item<=0){
        printf("Feito\n");
        /*
            Se tal item se igualar a zero, a tarefa será dada como feita. O \n serve para arrumar o printf na função listaCompleta(). Digite 1 no painel para entender.
    ...
    do{
        ...
        switch(escolha){
            case 0:
                ...
                break;
            case 1:
                printf("Digite a nova quantidade de cachos de banana que você deseja comprar. Números negativos serão considerados como zero\n");
                scanf("%d", &novoValor);
